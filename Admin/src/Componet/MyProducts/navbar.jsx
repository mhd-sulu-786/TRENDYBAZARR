...
const Navbar = ({fetch}) => {
  ...
  const categories = [
    ...
    { name: "Tshirt", cat: "tshirt" },
    { name: "Jeans", cat: "jeans" },
    { name: "Pant", cat: "pant" },
    { name: "Hoodie", cat: "hoodie" },
    { name: "Speaker", cat: "speaker" },
    { name: "Shoes", cat: "shoes" },
    { name: "Watch", cat: "watch" },
    { name: "Sunglass", cat: "sunglass" },
    { name: "Wallet", cat: "wallet" },
    { name: "Headphone", cat: "headphone" },
  ];
